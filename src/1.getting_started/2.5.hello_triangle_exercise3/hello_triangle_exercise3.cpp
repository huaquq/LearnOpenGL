...
int main()
{
	...
	if (!success)
	{
		...
		std::cout << "ERROR::SHADER::VERTEX::COMPILE FALIED!\n " << infoLog << std::endl;
	}
	...
	if (!success)
	{
		...
		std::cout << "ERROR::SHADER::FRAGMENT::COMPILE FALIED!\n " << infoLog << std::endl;
	}

	GLuint fragmentShader2 = 0;
	...
	if (!success)
	{
		...
		std::cout << "ERROR::SHADER::FRAGMENT2::COMPILE FALIED!\n " << infoLog << std::endl;
	}

	GLuint programShader = 0;
